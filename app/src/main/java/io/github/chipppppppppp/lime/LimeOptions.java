...
public class LimeOptions {
    ...
    public Option preventMarkAsRead = new Option("prevent_mark_as_read", R.string.switch_prevent_mark_as_read, true);
    public Option preventUnsendMessage = new Option("prevent_unsend_message", R.string.switch_prevent_unsend_message, true);
    public Option archived = new Option("archived_message", R.string.switch_archived, false);
    public Option sendMuteMessage = new Option("mute_message", R.string.switch_send_mute_message, true);
    public Option ReadChecker = new Option("ReadChecker", R.string.ReadChecker, true);
    ...
    public Option stopVersionCheck = new Option("stop_version_check", R.string.switch_stop_version_check, true);
